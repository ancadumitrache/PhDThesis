...
% these are the topics of the thesis, and this is the related work
% indicate the main venues of publication for this topic
% are there any fields or subfields that we know that are relevant to this topic: HCOMP, HCOMP journal, CHI, EMNLP/ACL, NIPS, WebConf, TiiS, Semantic Web Journal, ISWC, ESWC
% refer to the communities more specifically
...
% refer to the specific area of relation extraction + add frames
...
% mention that this applies to multiple NLP tasks, as opposed to the other sections that are more about RelEx and Frame Dis
% add a concluding paragraph - discuss the lack of unified theory of how to deal with that
% types of ambiguity, sources of ambiguity, ways of dealing with it
