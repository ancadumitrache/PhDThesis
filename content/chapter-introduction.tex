...
Finally, we have developed the CrowdTruth methodology for aggregating crowdsourcing results as an open-source software package,\footnote{\url{https://github.com/CrowdTruth/CrowdTruth-core}
