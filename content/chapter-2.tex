...
\toprule
& \textbf{Dataset} & \cellcolor{aliceblue}\textbf{P} & \cellcolor{aliceblue}\textbf{P'} & \textbf{R} & \textbf{R'} & \cellcolor{aliceblue}\textbf{F1} & \cellcolor{aliceblue}\textbf{F1'}   \\ \toprule
...
%\hline
\toprule
\multirow{2}{*}{\textbf{Sentence}} & \multirow{2}{*}{\textbf{Relation}} & \textbf{Crowd Label} & \textbf{Expert Label} \\ \toprule
