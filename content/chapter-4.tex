...
\addcontentsline{lof}{chapter}{\textsc{Chap.~\ref{chap:od-rel-ex}: Learning Relation Classification from the Crowd}}
\addcontentsline{lot}{chapter}{\textsc{Chap.~\ref{chap:od-rel-ex}: Learning Relation Classification from the Crowd}}
...
{\color{blue} This chapter makes the following contributions:
