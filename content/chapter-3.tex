...
\begin{table}
    ...
    \textbf{majority vote} &  0 & 0 & 1 & 0 & 0 \\ \bottomrule
    \end{tabular}
    }
\end{table}
...
\toprule
\textbf{Task} & \textbf{Dataset} & \textbf{Precision} & \textbf{Recall} & \textbf{F1 score} & \textbf{Accuracy} &  \textbf{Threshold} \\ \toprule
...
\begin{tabular}{rccc}
\toprule
\textbf{Task} & \textbf{Maj. Vote} & \textbf{Expert} & \textbf{Single} \\ \toprule
...
\multirow{2}{*}{\textbf{Media Unit}} & \multirow{2}{*}{\textbf{Annotation}} & \textbf{Expert} & \textbf{Crowd} & \textbf{Trusted} \\ 
 & & \textbf{Judgment} & \textbf{Score} & \textbf{Judgment} \\ \toprule
...
\multirow{2}{*}{\textbf{Media Unit URL}} & \textbf{Media Unit} & \multirow{2}{*}{\textbf{Annotation}} & \textbf{Expert} & \textbf{Crowd} & \textbf{Trusted} \\ 
 & \textbf{Description} &  & \textbf{Judgment} & \textbf{Score} & \textbf{Judgment} \\ \toprule
