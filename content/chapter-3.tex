...
\caption{Medical relation extraction task template.}
\label{fig:screenshot_medical}
\end{figure}
...
\caption{Twitter event identification task template.}
\label{fig:screenshot_tweets}
\end{figure}
...
\caption{News event extraction task template.}
\label{fig:screenshot_news}
\end{figure}
...
\caption{Sound interpretation task template.}
\label{fig:screenshot_sounds}
\end{figure}
