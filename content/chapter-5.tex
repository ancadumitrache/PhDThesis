...
\subsection{Ambiguity in the Frame-Sentence Expression}
...
\begin{table}[t!]
    ...
    \begin{tabular}{cccccc}
        ...
        %  \textbf{\textsc{Test Set}} & \textbf{\textsc{Eval. Metric}} & \textbf{OS} & \textbf{OS+}  & \textbf{FS} \\ \hline
          & \textsc{Eval. Metric} & \textbf{OS} & \textbf{OS+}  & \textbf{FS} & \cellcolor{aliceblue} \textbf{TC} \\ \toprule
                      & Kendall's $\uptau$  AUC & 0.339 & \textbf{0.477} & 0.279 & \cellcolor{aliceblue} 0.466 \\
         \textsc{R-}  & Kendall's $\uptau$ w-avg & 0.362 & \textbf{0.497} & 0.3 & \cellcolor{aliceblue} 0.48 \\
         \textsc{Set} & Cos Sim AUC & 0.57 & \textbf{0.685} & 0.518 & \cellcolor{aliceblue} 0.818 \\ 
                      & Cos Sim w-avg & 0.608 & \textbf{0.717} & 0.545 & \cellcolor{aliceblue} 0.854 \\ \toprule
         
                     & Kendall's $\uptau$ AUC & 0.269 & \textbf{0.379} & 0.253 & \cellcolor{aliceblue} 0.491 \\
         \textsc{F-} & Kendall's $\uptau$ w-avg & 0.307 & \textbf{0.421} & 0.284 & \cellcolor{aliceblue} 0.501 \\
         \textsc{Set} & Cos Sim AUC & 0.453 & \textbf{0.544} & 0.511 & \cellcolor{aliceblue} 0.810 \\
                      & Cos Sim w-avg & 0.515 & \textbf{0.607} & 0.539 & \cellcolor{aliceblue} 0.849 \\ \bottomrule
    \end{tabular}
    }
