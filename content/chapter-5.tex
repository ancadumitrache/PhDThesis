...
Similarly to Chapter~\ref{sec:chap4_metrics}, we employ version 2.0 of the metrics~\cite{dumitrache2018crowdtruth}, which explicitly models the interdependence between sentences, frames and workers.}
...
{\color{blue} \subsection{Ambiguity \& Sentence Quality}}
...
{\color{blue} \subsection{Ambiguity \& Frame Quality}}
